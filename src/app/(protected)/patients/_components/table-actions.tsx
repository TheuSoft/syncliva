...
import { deletePatient } from "@/actions/pacientes/delete-patient";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
const PatientsTableActions = ({ patient }: TableActionsProps) => {
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Esta ação é permanente. A exclusão irá remover o paciente e
